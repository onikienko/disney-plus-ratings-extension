const getYears = () => {
    ...
    const span = document.querySelector('#details_index > div > article > div.sc-hTQSVH.cUDiDZ > div > div:nth-child(1) > p > div > div.sc-fyjYeE.eLawYF > span');
...
export const getDisneyId = () => {
    ...
    // 7OLRMMgd1vkx
    // dbko8SML1qB8
    // decide that ID is at the end of the path and always has 12 characters (numbers and a-z)
